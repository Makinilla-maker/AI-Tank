...
namespace BBUnity.Conditions
{
    ...
    public class BulletsCounterBlue : GOCondition
    {
        ...
        {
            if(GameObject.Find("Dictator Tank").GetComponent<BulletManager>().bullets.Count > 0)
            {
                return false;
            }
            else
